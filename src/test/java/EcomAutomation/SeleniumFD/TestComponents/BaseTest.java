...
public class BaseTest {
	...
	public WebDriver intializeWebdriver() throws IOException {
		...
		FileInputStream FIS = new FileInputStream(System.getProperty("user.dir")
				+ "//src//main//java//EcomAutomation//SeleniumFD//resources//GlobalData.properties");
		prop.load(FIS);
	...
	public LoginPage lauchApplication() throws IOException {
		...
		// Calling method for hitting on loginPage URL.
